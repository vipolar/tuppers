...
var app = (function () {
    ...
    const graphPaddingLeft = writable(0);
    const graphPaddingTop = writable(0);
    ...
    // (157:3) {#each Array(17) as _, indexPix (indexPix)}
    function create_each_block_1$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "pixel-" + /*indexCol*/ ctx[24] + "-" + (16 - /*indexPix*/ ctx[26]));
    			...
    			add_location(div, file$4, 157, 4, 4682);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(157:3) {#each Array(17) as _, indexPix (indexPix)}",
    		ctx
    	});
    ...
    // (155:1) {#each Array(106) as _, indexCol (indexCol)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const get_key = ctx => /*indexPix*/ ctx[26];
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$4, 155, 2, 4546);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(155:1) {#each Array(106) as _, indexCol (indexCol)}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const get_key = ctx => /*indexCol*/ ctx[24];
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "height", 17 * /*pixelSize*/ ctx[0] + "px");
    			add_location(div, file$4, 149, 0, 4062);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div, "dragstart", /*handleCanvasDragStart*/ ctx[9], false, false, false),
    					listen_dev(div, "touchstart", /*handleCanvasTouchStart*/ ctx[1], false, false, false),
    					listen_dev(div, "touchmove", /*handleCanvasTouchMove*/ ctx[2], false, false, false),
    					listen_dev(div, "touchcancel", /*handleCanvasTouchCancel*/ ctx[3], false, false, false),
    					listen_dev(div, "touchend", /*handleCanvasTouchEnd*/ ctx[4], false, false, false),
    					listen_dev(div, "mousedown", /*handleCanvasMouseDown*/ ctx[5], false, false, false),
    					listen_dev(div, "mousemove", /*handleCanvasMouseMove*/ ctx[6], false, false, false),
    					listen_dev(div, "mouseleave", /*handleCanvasMouseLeave*/ ctx[7], false, false, false),
    					listen_dev(div, "mouseup", /*handleCanvasMouseUp*/ ctx[8], false, false, false)
    				];
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('pixelSize' in $$props) $$invalidate(0, pixelSize = $$props.pixelSize);
    		if ('kValueArray' in $$props) kValueArray = $$props.kValueArray;
    		if ('isMouseDown' in $$props) isMouseDown = $$props.isMouseDown;
    		if ('isTouchDown' in $$props) isTouchDown = $$props.isTouchDown;
    		if ('kValueString' in $$props) kValueString = $$props.kValueString;
    		if ('pixelOffsetX' in $$props) pixelOffsetX = $$props.pixelOffsetX;
    		if ('pixelOffsetY' in $$props) pixelOffsetY = $$props.pixelOffsetY;
    		if ('arrayCol' in $$props) arrayCol = $$props.arrayCol;
    		if ('arrayPix' in $$props) arrayPix = $$props.arrayPix;
    		if ('pixelID' in $$props) pixelID = $$props.pixelID;
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 85, 4, 2585);
    			add_location(sub, file$1, 90, 165, 3105);
    			add_location(i, file$1, 90, 161, 3101);
    			...
    			add_location(button0, file$1, 90, 12, 2952);
    			...
    			add_location(textarea, file$1, 91, 12, 3154);
    			...
    			add_location(div1, file$1, 89, 8, 2846);
    			...
    			add_location(button1, file$1, 94, 12, 3487);
    			...
    			add_location(button2, file$1, 95, 12, 3678);
    			...
    			add_location(button3, file$1, 96, 12, 3855);
    			...
    			add_location(button4, file$1, 98, 16, 4146);
    			...
    			add_location(button5, file$1, 99, 16, 4295);
    			...
    			add_location(button6, file$1, 100, 16, 4445);
    			...
    			add_location(div2, file$1, 97, 12, 4030);
    			...
    			add_location(div3, file$1, 93, 9, 3381);
    			...
    			add_location(div4, file$1, 88, 4, 2753);
    			...
    			add_location(div5, file$1, 84, 0, 2468);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t16 = space();
    			div15 = element("div");
    			attr_dev(h1, "class", "blanket-loading-text svelte-30xhhu");
    			add_location(h1, file, 83, 12, 3238);
    			attr_dev(div0, "class", "cell d-0 svelte-30xhhu");
    			add_location(div0, file, 85, 12, 3300);
    			attr_dev(div1, "class", "cell d-1 svelte-30xhhu");
    			add_location(div1, file, 86, 12, 3341);
    			attr_dev(div2, "class", "cell d-2 svelte-30xhhu");
    			add_location(div2, file, 87, 12, 3382);
    			attr_dev(div3, "class", "cell d-3 svelte-30xhhu");
    			add_location(div3, file, 88, 12, 3423);
    			attr_dev(div4, "class", "cell d-1 svelte-30xhhu");
    			add_location(div4, file, 89, 12, 3464);
    			attr_dev(div5, "class", "cell d-2 svelte-30xhhu");
    			add_location(div5, file, 90, 12, 3505);
    			attr_dev(div6, "class", "cell d-3 svelte-30xhhu");
    			add_location(div6, file, 91, 12, 3546);
    			attr_dev(div7, "class", "cell d-4 svelte-30xhhu");
    			add_location(div7, file, 92, 12, 3587);
    			attr_dev(div8, "class", "cell d-2 svelte-30xhhu");
    			add_location(div8, file, 93, 12, 3628);
    			attr_dev(div9, "class", "cell d-3 svelte-30xhhu");
    			add_location(div9, file, 94, 12, 3669);
    			attr_dev(div10, "class", "cell d-4 svelte-30xhhu");
    			add_location(div10, file, 95, 12, 3710);
    			attr_dev(div11, "class", "cell d-5 svelte-30xhhu");
    			add_location(div11, file, 96, 12, 3751);
    			attr_dev(div12, "class", "cell d-3 svelte-30xhhu");
    			add_location(div12, file, 97, 12, 3792);
    			attr_dev(div13, "class", "cell d-4 svelte-30xhhu");
    			add_location(div13, file, 98, 12, 3833);
    			attr_dev(div14, "class", "cell d-5 svelte-30xhhu");
    			add_location(div14, file, 99, 12, 3874);
    			attr_dev(div15, "class", "cell d-6 svelte-30xhhu");
    			add_location(div15, file, 100, 12, 3915);
    			attr_dev(div16, "class", "blanket-loading-mosaic svelte-30xhhu");
    			set_style(div16, "--cell-size", 64 * (/*pixelSize*/ ctx[0] / 10) + "px");
    			add_location(div16, file, 82, 8, 3142);
    			attr_dev(div17, "class", "blanket-loading svelte-30xhhu");
    			add_location(div17, file, 81, 4, 3104);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block = /*loaderDisplay*/ ctx[6] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "butons-container-debug svelte-30xhhu");
    			set_style(h1, "font-size", /*pixelSize*/ ctx[0] / 10 + "em");
    			add_location(h1, file, 77, 4, 2953);
    			attr_dev(div, "class", "butons-container svelte-30xhhu");
    			set_style(div, "width", 116 * /*pixelSize*/ ctx[0] + "px");
    			set_style(div, "height", 34 * /*pixelSize*/ ctx[0] + "px");
    			set_style(div, "transform", "rotate(" + /*windowRotateDeg*/ ctx[3] + "deg) translate(" + /*windowTranslateX*/ ctx[4] + "px, " + /*windowTranslateY*/ ctx[5] + "px)");
    			add_location(div, file, 75, 0, 2711);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*windowRotateDeg, windowTranslateX, windowTranslateY*/ 56) {
    				set_style(div, "transform", "rotate(" + /*windowRotateDeg*/ ctx[3] + "deg) translate(" + /*windowTranslateX*/ ctx[4] + "px, " + /*windowTranslateY*/ ctx[5] + "px)");
    			}

    			if (/*loaderDisplay*/ ctx[6]) {
    				if (if_block) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const setPixelSize = () => {
    		/* display loader */
    		$$invalidate(6, loaderDisplay = true);
    		...
    		if (window.matchMedia("(orientation: portrait)").matches) {
    			...
    			$$invalidate(4, windowTranslateX = (windowHeight - (windowHeight - pixelSize * 116) / 2) * -1);

    			$$invalidate(5, windowTranslateY = (windowWidth - pixelSize * 34) / 2);
    			...
    			/* adjust placement according to graph to window ratio */
    			$$invalidate(4, windowTranslateX = (windowWidth - pixelSize * 116) / 2);

    			$$invalidate(5, windowTranslateY = (windowHeight - pixelSize * 34) / 2);
    		...
    		setTimeout(
    			() => {
    				$$invalidate(6, loaderDisplay = false);
    			},
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('loaderDisplay' in $$props) $$invalidate(6, loaderDisplay = $$props.loaderDisplay);
    	};

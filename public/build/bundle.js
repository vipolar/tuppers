...
var app = (function () {
    ...
    // (187:3) {#each Array(17) as _, indexPix (indexPix)}
    function create_each_block_1$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "pixel-" + /*indexCol*/ ctx[21] + "-" + /*indexPix*/ ctx[23]);
    			attr_dev(div, "class", "matrix-pixel svelte-kxmo1v");
    			set_style(div, "width", /*pixelSize*/ ctx[0] + "px");
    			set_style(div, "height", /*pixelSize*/ ctx[0] + "px");
    			add_location(div, file$4, 187, 4, 6145);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(187:3) {#each Array(17) as _, indexPix (indexPix)}",
    		ctx
    	});
    ...
    // (185:1) {#each Array(106) as _, indexCol (indexCol)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const get_key = ctx => /*indexPix*/ ctx[23];
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "matrix-column svelte-kxmo1v");
    			set_style(div, "width", /*pixelSize*/ ctx[0] + "px");
    			set_style(div, "height", 17 * /*pixelSize*/ ctx[0] + "px");
    			add_location(div, file$4, 185, 2, 6009);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(185:1) {#each Array(106) as _, indexCol (indexCol)}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const get_key = ctx => /*indexCol*/ ctx[21];
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			pre = element("pre");
    			add_location(i, file$4, 196, 15, 6792);
    			add_location(b, file$4, 196, 12, 6789);
    			attr_dev(canvas, "id", "canvas");
    			attr_dev(canvas, "class", "canvas svelte-kxmo1v");
    			...
    			set_style(canvas, "display", /*displayCanvas*/ ctx[1]);
    			add_location(canvas, file$4, 193, 4, 6395);
    			attr_dev(pre, "id", "log");
    			attr_dev(pre, "class", "matrix-log svelte-kxmo1v");
    			set_style(pre, "display", "block");
    			set_style(pre, "bottom", "0");
    			set_style(pre, "left", "0");
    			add_location(pre, file$4, 200, 4, 6943);
    			attr_dev(div, "id", "matrix");
    			attr_dev(div, "class", "matrix svelte-kxmo1v");
    			set_style(div, "width", 106 * /*pixelSize*/ ctx[0] + "px");
    			set_style(div, "height", 17 * /*pixelSize*/ ctx[0] + "px");
    			add_location(div, file$4, 183, 0, 5865);
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('displayCanvas' in $$props) $$invalidate(1, displayCanvas = $$props.displayCanvas);
    		...
    		if ('pixelCol' in $$props) pixelCol = $$props.pixelCol;
    		if ('pixelRow' in $$props) pixelRow = $$props.pixelRow;
    		if ('pixelElement' in $$props) pixelElement = $$props.pixelElement;
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 69, 4, 2562);
    			...
    			add_location(div, file, 67, 0, 2319);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const setPixelSize = () => {
    		...
    		const balancePixelSize = () => {
    			...
    			$$invalidate(0, pixelSize = pixelSize <= 16 ? pixelSize : 16);

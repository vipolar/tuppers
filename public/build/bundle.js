...
var app = (function () {
    ...
    // (295:20) {#each Array(27) as _, indexPix (indexPix)}
    function create_each_block_7(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 295, 24, 10814);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(295:20) {#each Array(27) as _, indexPix (indexPix)}",
    		ctx
    	});
    ...
    // (293:12) {#each Array(5) as _, indexCol (indexCol)}
    function create_each_block_6(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 293, 16, 10705);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(293:12) {#each Array(5) as _, indexCol (indexCol)}",
    		ctx
    	});
    ...
    // (302:20) {#each Array(5) as _, indexPix (indexPix)}
    function create_each_block_5(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "pixel frame-pixel svelte-4gs6t4");
    			add_location(div, file, 302, 24, 11104);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(302:20) {#each Array(5) as _, indexPix (indexPix)}",
    		ctx
    	});
    ...
    // (305:20) {#each Array(17) as _, indexPix (indexPix)}
    function create_each_block_4(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "pixel-" + /*indexCol*/ ctx[24] + "-" + /*indexPix*/ ctx[26]);
    			attr_dev(div, "class", "pixel canvas-pixel svelte-4gs6t4");
    			add_location(div, file, 305, 24, 11258);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(305:20) {#each Array(17) as _, indexPix (indexPix)}",
    		ctx
    	});
    ...
    // (308:20) {#each Array(5) as _, indexPix (indexPix)}
    function create_each_block_3(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "pixel frame-pixel svelte-4gs6t4");
    			add_location(div, file, 308, 24, 11445);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(308:20) {#each Array(5) as _, indexPix (indexPix)}",
    		ctx
    	});
    ...
    // (300:12) {#each Array(106) as _, indexCol (indexCol)}
    function create_each_block_2(key_1, ctx) {
    	...
    	const get_key_1 = ctx => /*indexPix*/ ctx[26];
    	...
    	const get_key_2 = ctx => /*indexPix*/ ctx[26];
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(div, "class", "column svelte-4gs6t4");
    			add_location(div, file, 300, 16, 10996);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(300:12) {#each Array(106) as _, indexCol (indexCol)}",
    		ctx
    	});
    ...
    // (315:20) {#each Array(27) as _, indexPix (indexPix)}
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "pixel frame-pixel svelte-4gs6t4");
    			add_location(div, file, 315, 24, 11734);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(315:20) {#each Array(27) as _, indexPix (indexPix)}",
    		ctx
    	});
    ...
    // (313:12) {#each Array(5) as _, indexCol (indexCol)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "column svelte-4gs6t4");
    			add_location(div, file, 313, 16, 11625);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(313:12) {#each Array(5) as _, indexCol (indexCol)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const get_key_1 = ctx => /*indexCol*/ ctx[24];
    	...
    	const get_key_2 = ctx => /*indexCol*/ ctx[24];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 291, 8, 10549);
    			add_location(i0, file, 325, 23, 12407);
    			add_location(b0, file, 325, 20, 12404);
    			...
    			add_location(canvas, file, 322, 8, 11963);
    			...
    			add_location(div1, file, 329, 8, 12554);
    			...
    			add_location(div2, file, 330, 8, 12672);
    			...
    			add_location(div3, file, 331, 8, 12790);
    			...
    			add_location(div4, file, 332, 8, 12909);
    			attr_dev(div5, "class", "canvas-overlay-axis-y-arrow-body svelte-4gs6t4");
    			add_location(div5, file, 336, 12, 13223);
    			...
    			add_location(div6, file, 337, 12, 13288);
    			add_location(b1, file, 339, 154, 13691);
    			...
    			add_location(div7, file, 339, 16, 13553);
    			add_location(i1, file, 341, 171, 14007);
    			add_location(b2, file, 341, 168, 14004);
    			...
    			add_location(div8, file, 341, 20, 13856);
    			add_location(i2, file, 342, 168, 14194);
    			add_location(b3, file, 342, 165, 14191);
    			...
    			add_location(div9, file, 342, 20, 14046);
    			...
    			add_location(div10, file, 340, 16, 13723);
    			...
    			add_location(div11, file, 338, 12, 13429);
    			...
    			add_location(div12, file, 335, 8, 13114);
    			attr_dev(div13, "class", "canvas-overlay-axis-x-arrow-body svelte-4gs6t4");
    			add_location(div13, file, 349, 12, 14478);
    			...
    			add_location(div14, file, 350, 12, 14544);
    			add_location(b4, file, 352, 158, 14954);
    			...
    			add_location(div15, file, 352, 16, 14812);
    			add_location(i3, file, 354, 143, 15243);
    			add_location(b5, file, 354, 140, 15240);
    			...
    			add_location(div16, file, 354, 20, 15120);
    			add_location(i4, file, 355, 144, 15406);
    			add_location(b6, file, 355, 141, 15403);
    			...
    			add_location(div17, file, 355, 20, 15282);
    			...
    			add_location(div18, file, 353, 16, 14986);
    			...
    			add_location(div19, file, 351, 12, 14687);
    			...
    			add_location(div20, file, 348, 8, 14368);
    			...
    			add_location(div21, file, 290, 4, 10447);
    			add_location(sub, file, 364, 165, 15967);
    			add_location(i5, file, 364, 161, 15963);
    			...
    			add_location(button0, file, 364, 12, 15814);
    			...
    			add_location(textarea, file, 365, 12, 16016);
    			...
    			add_location(div22, file, 363, 8, 15708);
    			...
    			add_location(button1, file, 368, 12, 16408);
    			...
    			add_location(button2, file, 369, 12, 16630);
    			...
    			add_location(button3, file, 370, 12, 16836);
    			...
    			add_location(button4, file, 372, 16, 17157);
    			...
    			add_location(button5, file, 373, 16, 17311);
    			...
    			add_location(button6, file, 374, 16, 17497);
    			...
    			add_location(div23, file, 371, 12, 17039);
    			...
    			add_location(div24, file, 367, 9, 16302);
    			...
    			add_location(div25, file, 362, 4, 15547);
    			...
    			add_location(div26, file, 380, 4, 17800);
    			...
    			add_location(div27, file, 289, 0, 10356);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function canvasFillPattern(k) {
    		...
    		let pixelRow = 0;
    		let pixelElement;
    		if (k.length !== 1802 || k === kValueBinary) return;
    	...
    	function kValuePasteButton(e) {
    		...
    		if (typeof navigator.clipboard.readText === "function") {
    			...
    			if (kValueStringTemp.length > 0) {
    				$$invalidate(0, kValueString = kValueStringTemp);
    				kValueChangeHandler();
    			} else {
    	...
    	function kValueChangeHandler() {
    		...
    		if (document.activeElement !== targetElement) {
    			if (kValueIsValid) {
    				...
    				$$invalidate(0, kValueString = kValueBinaryToBase(kValueBinaryTemp, kValueBase));
